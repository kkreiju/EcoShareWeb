...
export function TransactionEmptyState({ type }: TransactionEmptyStateProps) {
  ...
  return (
    <div className={`text-center py-16 rounded-xl border border-${emptyStateColor}-200/50 bg-gradient-to-br from-${emptyStateColor}-50/50 to-${emptyStateColor}-100/30 dark:from-${emptyStateColor}-950/20 dark:to-${emptyStateColor}-900/10`}>
