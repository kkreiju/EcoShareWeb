...
export interface ListingFiltersComponentProps {
...
export function ListingFiltersComponent({
  ...
  const updateFilter = (key: keyof ListingFilters, value: string | null) => {
    const newFilters = {
      ...filters,
      [key]: value === "all" || value === null || value === "" ? undefined : value,
    };
      ...
      {hasActiveFilters && (
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-1.5">
            ...
            {showPriceFilter && filters.price && filters.price !== "all" && (
              <Badge
                variant="secondary"
                className="text-xs px-2 py-1 cursor-pointer hover:bg-secondary/80"
            ...
            {showSortFilter && filters.sort_by && filters.sort_by !== null && (
              <Badge
                variant="secondary"
                className="text-xs px-2 py-1 cursor-pointer hover:bg-secondary/80"
              ...
              >
                ...
                {!["newest", "oldest", "price_high", "price_low"].includes(filters.sort_by as string) && `Sort: ${filters.sort_by}`}
                <X className="w-3 h-3 ml-1" />
              </Badge>
            )}
          </div>
        ...
        {showSortFilter && (
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                value ? updateFilter("sort_by", value) : updateFilter("sort_by", null)
              }
            >
  ...
  return (
    <div className="flex items-center justify-between p-4 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Nearby Button - Desktop - Only show for premium users */}
        {showNearbyButton &&
