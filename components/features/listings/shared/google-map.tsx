...
/**
 * Google Map Component - Shared component for location selection
 * Supports both add-listing (no initial coords) and edit-listing (with initial coords) use cases
 */
    ...
    if (initialLat && initialLng) {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          ...
          (error) => {
            // Update with default location if geolocation fails
